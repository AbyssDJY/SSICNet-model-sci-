...
def visualize_labels(labels=None, output_path='classification_map.png'):
    ...
    if labels is None:
        possible_paths = [
'./results/cacftnet/Houston/Label_PRED.npy'
    ...
    colors = [
        [0, 0, 0],                # 背景：黑色
        [1.0, 0, 0],               # 1. Grass-healthy：红色
        [238/255, 154/255, 0],             # 2. Grass-stressed：橘黄色
        [1.0, 1.0, 0],            # 3. Grass-synergic：黄色
        [0, 1.0, 0],               # 4. Tree：绿色
        [0, 1.0, 1.0],             # 5. Soil：青色
        [0, 139/255, 139/255],               # 6. Water：蓝青色
        [0, 0, 1],               # 7. Residential：蓝色
        [1.0, 1.0, 1.0],           # 8. Commercial：白色
        [160/255, 32/255, 1.0],             # 9. Road：紫色
        [85/255, 107/255, 47/255],               # 10. Highway：军绿色
        [1.0, 69/255, 0],             # 11. Railway：橙色
        [0.5, 0.5, 0.5],           # 12. Parking lot 1：灰色
        [47/255, 79/255, 79/255],           # 13. Parking lot 2：浅灰色
        [75/255, 0, 130/255],             # 14. Tennis court：深紫色
        [136/255, 44/255, 81/255],               # 15. Running track：浅红色
    ]
