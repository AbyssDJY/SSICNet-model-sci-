...
def plot_confusion_matrix(cm, labels_name, title):
    ...
    plt.savefig('D:\PycharmProjects\HSI\Summary of Three Projects During M.D\Lite-HCNet-2023 IEEE TGRS\Result/'+data+'-'+title+'.png')
    plt.show()
...
# data = 'UP'
# class_num = 9
# X = sio.loadmat('D:\PycharmProjects\HSI\Various documents\data\PaviaU.mat')['paviaU']
# y = sio.loadmat('D:\PycharmProjects\HSI\Various documents\data\PaviaU_gt.mat')['paviaU_gt']
...
if __name__ == "__main__":
    ...
    Xtrain, Xtest, ytrain, ytest = split_data(X_pca, y, test_ratio)
...
# load the original image
    ...
    sio.savemat('D:\PycharmProjects\HSI\Summary of Three Projects During M.D/Lite-HCNet-2023 IEEE TGRS\Result/'+data+'-'+train_ratio+'.mat',mdict={'outputs': outputs})
    ypr = sio.loadmat('D:\PycharmProjects\HSI\Summary of Three Projects During M.D/Lite-HCNet-2023 IEEE TGRS\Result/'+data+'-'+train_ratio+'.mat')['outputs']
