...
class ViT(nn.Module):
    def __init__(self, image_size, near_band, num_patches, num_classes, channels_band, dim=64, depth=5, heads=4, mlp_dim=8, pool='cls',
                 dim_head=16, dropout=0.1, emb_dropout=0.1, mode='ViT', patch_size = 7):
        super().__init__()
