...
def args_parser():
    ...
    parser.add_argument('--checkpointsmodelfile', type=str, default='./checkpoints/f3d/Houston/model_98.55.pth')
...
def main():
    ...
    model = F3D(class_num=args.num_class, dataset_name=args.dataset).to(device)
