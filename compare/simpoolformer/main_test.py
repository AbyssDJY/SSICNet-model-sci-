...
def args_parser():
    ...
    parser.add_argument('--modelfile', type=str, default='./checkpoints/simpoolformer/Houston/model_97.63.pth')
...
def main():
    ...
    _, test_loader = build_data_sim_loader(args)
    ...
    print(f"Test time: {elapsed_time:.2f} seconds") # 输出测试用时
