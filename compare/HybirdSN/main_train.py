...
def args_parser():
    ...
    parser.add_argument('-dataset', type=str, default='WHU_Hi_LongKou', 
    ...
    parser.add_argument('--train_ratio', type=float, default=0.002,
...
def main():
    ...
    # 打印模型结构
    print(f"HybridSN模型结构已创建，类别数: {args.num_class}")
